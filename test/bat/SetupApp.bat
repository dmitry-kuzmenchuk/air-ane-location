...
:: Android packaging
set AND_CERT_NAME="LocationTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\LocationTest.p12
...
set IOS_PROVISION=cert\LocationTest.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=LocationTest

:: Debugging using a custom IP
set DEBUG_IP=192.168.1.197
